...
TODO: rename these, they sound like jobs.

| Class    | Element   | Letter | Word    | Native Region     |   |
|----------+-----------+--------+---------+-------------------+---|
| theif    | Dark      | bet    | xashekh | underground       |   |
| merchant | Earth     | dalet  | aretz   | camps             |   |
| hunter   | Water     | gimel  | mayim   | caravan           |   |
| chef     | Fire      | kaf    | yesh    | village           |   |
| fighter  | Wind      | peh    | ruax    | boats and ships   |   |
| artist   | Void/Mind | resh   | neshama | city              |   |
| monk     | Light     | tau    | aur     | temple and palace |   |

theif gathers and steals for merchant,
merchant sells to hunter,
chef cooks from hunter,
fighter eats from chef,
artist draws and sings from fighter,
monk reflects on artist,
monk gives to theif.
